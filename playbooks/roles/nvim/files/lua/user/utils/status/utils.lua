...
--
-- This module can be loaded with `local status_utils = require "user.utils.status.utils"`
--
-- @module user.utils.status.utils
-- @copyright 2023
...
-- @usage local string = require("user.utils.status").utils.stylize("Hello", { padding = { left = 1, right = 1 }, icon = { kind = "String" } })
...
-- @usage local heirline_component = { on_click = { callback = function(...) local args = require("user.utils.status").utils.statuscolumn_clickargs(...) end } }
