...
--
-- This module can be loaded with `local component = require "user.utils.status.component"`
--
-- @module user.utils.status.component
-- @copyright 2023
...
local hl = require "user.utils.status.hl"
local init = require "user.utils.status.init"
local provider = require "user.utils.status.provider"
...
-- @usage local heirline_component = require("user.utils.status").component.fill()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("user.utils.status").component.file_info()
...
---@param opts? table options for configuring file_icon, filename, filetype, file_modified, file_read_only, and the overall padding
---@return table # The Heirline component table
-- @usage local heirline_component = require("user.utils.status").component.tabline_file_info()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("user.utils.status").component.nav()
function M.nav(opts)
  opts = extend_tbl({
    ruler = {},
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("user.utils.status").component.cmd_info()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("user.utils.status").component.mode { mode_text = true }
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("user.utils.status").component.breadcumbs()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("user.utils.status").component.separated_path()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("user.utils.status").component.git_branch()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("user.utils.status").component.git_diff()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("user.utils.status").component.diagnostics()
...
---@param opts? table options for configuring diagnostic providers and the overall padding
---@return table # The Heirline component table
-- @usage local heirline_component = require("user.utils.status").component.treesitter()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("user.utils.status").component.lsp()
function M.lsp(opts)
  opts = extend_tbl({
    lsp_progress = {
      str = "",
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("user.utils.status").component.foldcolumn()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("user.utils.status").component.numbercolumn()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("user.utils.status").component.signcolumn()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("user.utils.status").components.builder({ { provider = "file_icon", opts = { padding = { right = 1 } } }, { provider = "filename" } })
