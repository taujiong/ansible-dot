...
--
-- This module can be loaded with `local hl = require "user.utils.status.hl"`
--
-- @module user.utils.status.hl
-- @copyright 2023
...
-- @usage local heirline_component = { provider = "Example Provider", hl = require("user.utils.status").hl.mode },
...
-- @usage local heirline_component = require("heirline.utils").surround({ "|", "|" }, require("user.utils.status").hl.mode_bg, heirline_component),
...
-- @usage local heirline_component = { provider = require("user.utils.status").provider.fileicon(), hl = require("user.utils.status").hl.filetype_color },
...
-- @usage local heirline_component = { provider = "Example Provider", hl = require("user.utils.status").hl.get_attributes("treesitter") },
...
-- @usage local heirline_component = { provider = "Example Provider", hl = require("user.utils.status").hl.file_icon("winbar") },
