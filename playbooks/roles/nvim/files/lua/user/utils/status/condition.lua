...
--
-- This module can be loaded with `local condition = require "user.utils.status.condition"`
--
-- @module user.utils.status.condition
-- @copyright 2023
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("user.utils.status").condition.is_active }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = function() return require("user.utils.status").condition.buffer_matches { buftype = { "terminal" } } end }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("user.utils.status").condition.is_macro_recording }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("user.utils.status").condition.is_hlsearch }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("user.utils.status").condition.is_statusline_showcmd }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("user.utils.status").condition.is_git_repo }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("user.utils.status").condition.git_changed }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("user.utils.status").condition.file_modified }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("user.utils.status").condition.file_read_only }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("user.utils.status").condition.has_diagnostics }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("user.utils.status").condition.has_filetype }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("user.utils.status").condition.aerial_available }
...
---@param bufnr table|integer a buffer number to check the condition for, a table with bufnr property, or nil to get the current buffer
---@return boolean # whether or not LSP is attached
-- @usage local heirline_component = { provider = "Example Provider", condition = require("user.utils.status").condition.lsp_attached }
function M.lsp_attached(bufnr)
  ...
  return package.loaded["user.utils.lsp"] and next(vim.lsp.get_active_clients({ bufnr = bufnr or 0, })) ~= nil
end

--- A condition function if treesitter is in use
---@param bufnr table|integer a buffer number to check the condition for, a table with bufnr property, or nil to get the current buffer
---@return boolean # whether or not treesitter is active
-- @usage local heirline_component = { provider = "Example Provider", condition = require("user.utils.status").condition.treesitter_available }
