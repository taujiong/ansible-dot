...
--
-- This module can be loaded with `local ui = require("user.utils.ui")`
--
-- @module user.utils.ui
-- @see user.utils
-- @copyright 2022
...
local function ui_notify(silent, ...) return not silent and require("user.utils").notify(...) end
...
function M.toggle_diagnostics(silent)
  ...
  vim.diagnostic.config(require("user.utils.lsp").diagnostics[vim.g.diagnostics_mode])
...
function M.toggle_url_match(silent)
  ...
  require("user.utils").set_url_match()
