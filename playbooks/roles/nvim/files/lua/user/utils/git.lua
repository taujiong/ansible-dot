--- ### Git LUA API
--
-- This module can be loaded with `local git = require "user.utils.git"`
--
-- @module user.utils.git
-- @copyright 2022
...
function git.cmd(args, ...)
  ...
  return require("user.utils").cmd(vim.list_extend({ "git", "-C", user.install.home, }, args), ...)
end
...
function git.parse_remote_url(str)
  return vim.fn.match(str, require("user.utils").url_matcher) == -1
      and git.url .. str .. (vim.fn.match(str, "/") == -1 and "/user.git" or ".git")
      or str
end
...
---@param commits string[] an array like table of commit messages
---@return string[][] # An array like table of echo messages to provide to nvim_echo or user.echo
