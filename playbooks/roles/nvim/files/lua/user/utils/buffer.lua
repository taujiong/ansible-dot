...
--
-- This module can be loaded with `local buffer_utils = require "user.utils.buffer"`
--
-- @module user.utils.buffer
-- @copyright 2022
...
---@param compare_func string|function a string of a comparator defined in require("user.utils.buffer").comparator or a custom comparator function
...
local function unique_path(bufnr)
  return require("user.utils.status.provider").unique_path() { bufnr = bufnr, }
